    ...
    <main>
        ...
        <div class="container justify-content-center">
            <div class="row justify-content-center">
                ...
                <!-- BERITA KEEMPAT -->
                <div class="card col-sm-4 shadow p-3 mb-2 bg-body rounded" style="width: 350px;">
                    <img src="storage/blog/brt4.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <center>
                ...
                <!-- BERITA KELIMA -->
                <div class="card col-sm-4 shadow p-3 mb-2 bg-body rounded" style="width: 350px;">
                    <img src="storage/blog/brt5.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <center>
                ...
                <!-- BERITA KEENAM -->
                <div class="card col-sm-4 shadow p-3 mb-2 bg-body rounded" style="width: 350px;">
                    <img src="storage/blog/brt6.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <center>
                            ...
                            <p class="card-text">Sekolah Tinggi Teknologi Cipasung mengadakan Kuliah Ta’aruf Mahasiswa
                                ...
                                sebanyak...</p>
                            <div class="tombol">
                                <a href="https://sttcipasung.ac.id" class="btn btn-next">Selengkapnya</a>
                            </div>
                        </center>
                    </div>
                </div>
            ...
            <nav aria-label="Page navigation example" style="justify-items: center;">
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="blog2">Next</a></li>
                </ul>
            </nav>
            <br>
            <br>
